...
public class BooksDAO {
    ...
    public static void insertBook(Book book) throws GlobalException {
        ...
        try {
            ...
            pstmt.setInt(2, book.getGanre());
            pstmt.setString(3, book.getEdition());
            pstmt.setString(5, book.getDateOfEdition());
            pstmt.setString(6, book.getReview());
            pstmt.setInt(7, book.getPrice());
            pstmt.setInt(8, book.getCount());
            pstmt.executeUpdate();
            pstmt.close();
        } catch (SQLException ex) {
    ...
    private static Book extractBook(ResultSet rs) throws SQLException {
        ...
        book.setGanre(rs.getInt(DBFields.BOOK_GENRE_ID));
